...
create table message (id bigint generated by default as identity, text varchar(4096) not null, recipient_email varchar(255) not null, sender_email varchar(255) not null, primary key (id));
...
alter table message add constraint FKb944tffcq8o8omuojf97q7es9 foreign key (recipient_email) references users;
