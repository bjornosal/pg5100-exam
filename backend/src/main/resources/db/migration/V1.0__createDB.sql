...
-- create table quiz (id bigint generated by default as identity, answer01 varchar(128) not null, answer04 varchar(128) not null, index_of_correct_answer integer not null check (index_of_correct_answer>=0 AND index_of_correct_answer<=3), question varchar(128) not null, answer02 varchar(128) not null, answer03 varchar(128) not null, sub_category_id bigint not null, primary key (id));
