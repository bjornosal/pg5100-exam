...
create table message (id bigint generated by default as identity, text varchar(4096) not null, receiver_email varchar(255) not null, sender_email varchar(255) not null, primary key (id));
